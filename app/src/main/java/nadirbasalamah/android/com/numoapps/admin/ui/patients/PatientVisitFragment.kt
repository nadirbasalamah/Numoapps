...
import kotlinx.android.synthetic.main.fragment_patient_visit.*
...
class PatientVisitFragment : Fragment(), SearchView.OnQueryTextListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rv_patientvisitlist.setHasFixedSize(true)
        sv_patientvisitlist.setOnQueryTextListener(this)
    }
    ...
    private fun showPatientList() {
        rv_patientvisitlist.layoutManager = LinearLayoutManager(context)
        adapter = PatientsAdapter()
        adapter.notifyDataSetChanged()
        rv_patientvisitlist.adapter = adapter
    ...
    private fun showLoading(state: Boolean) {
        if(state) {
            pb_patientvisitlist.visibility = View.VISIBLE
        } else {
            pb_patientvisitlist.visibility = View.GONE
        }
    }
